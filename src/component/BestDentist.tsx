            ...
            <div className="row content-wrapper style-9 align-items-end">
                <div className="col-xl-6 col-lg-6 m-b30">
                    <div className="section-head style-2 m-b30">
                        ...
                        <p className="fw-normal wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="0.8s"><strong className="text-secondary fw-semibold">Dr. Richarl Nifom</strong> There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                    </div>
